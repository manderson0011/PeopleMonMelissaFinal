...
//Central router to create URLRequestConvertiable request
...
class WebServices: NSObject {
    ...
    // base URL private and public vars
    ...
    //look at request type and give it a network model it creates the url request.
